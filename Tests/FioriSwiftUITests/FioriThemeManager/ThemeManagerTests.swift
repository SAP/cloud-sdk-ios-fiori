...
class ThemeManagerTests: XCTestCase {
    override func tearDown() {
        ...
        func testPalette8() throws {
            ...
            let obsoletedStyle_line = tm.hexColor(for: .separatorOpaque)
            XCTAssertEqual(obsoletedStyle_line, HexColor(lightColor: "8396A8D4", darkColor: "5B738BD4", contrastLightColor: "A9B4BED4", contrastDarkColor: "354A5FD4"))
            let obsoletedStyle_negative = tm.hexColor(for: .negativeLabel)
            XCTAssertEqual(obsoletedStyle_negative, HexColor(lightColor: "FF5C77FF", darkColor: "AA0808FF", contrastLightColor: "FF8CB2FF", contrastDarkColor: "7F0505FF"))
        ...
        func testPaletteV7() throws {
            ...
            XCTAssertEqual(newStyle_primaryLabel, HexColor(lightColor: "F5F6F7FF", darkColor: "223548FF", contrastLightColor: "FFFFFFFF", contrastDarkColor: "000000FF"))
            let obsoletedStyle_line = tm.hexColor(for: .separatorOpaque)
            XCTAssertEqual(obsoletedStyle_line, HexColor(lightColor: "8396A8D4", darkColor: "5B738BD4", contrastLightColor: "9CA9B4FF", contrastDarkColor: "47596CEB"))
            let obsoletedStyle_negative = tm.hexColor(for: .negativeLabel)
            XCTAssertEqual(obsoletedStyle_negative, HexColor(lightColor: "FF8CB2FF", darkColor: "D20A0AFF", contrastLightColor: "FFADD1FF", contrastDarkColor: "9C0707FF"))
        }
        ...
        func testPaletteV6() throws {
            ...
            XCTAssertEqual(tm.paletteVersion?.obsoletedStyles().count, 2)
            XCTAssertEqual(tm.paletteVersion?.newStyles().count, 60)
            let newStyle_grey1 = tm.hexColor(for: .grey1)
            ...
            XCTAssertEqual(obsoletedStyle_line, HexColor(lightColor: "8396A8D4", darkColor: "5B738BD4", contrastLightColor: "9CA9B4FF", contrastDarkColor: "47596CEB"))
            let obsoletedStyle_negative = tm.hexColor(for: .negativeLabel)
            XCTAssertEqual(obsoletedStyle_negative, HexColor(lightColor: "FF5C77FF", darkColor: "D20A0AFF", contrastLightColor: "FFC2D6FF", contrastDarkColor: "840606FF"))
        }
    
        func testPaletteV5() throws {
            let tm = ThemeManager.shared
            tm.setPaletteVersion(.v5)
            let v5Style_primary1 = tm.hexColor(for: .primaryLabel)
            XCTAssertEqual(v5Style_primary1, HexColor(lightColor: "FAFAFA", darkColor: "32363A", contrastLightColor: "FAFAFA", contrastDarkColor: "FAFAFA"))
            ...
            let v5Style_shell = tm.hexColor(for: .header)
        ...
        func testPaletteV4() throws {
            ...
            let v4Style_primary1 = tm.hexColor(for: .primaryLabel)
            ...
            let v4Style_line = tm.hexColor(for: .separatorOpaque)
            XCTAssertEqual(v4Style_line, HexColor(lightColor: "38383A", darkColor: "F3F3F3"))
            let v4Style_negative = tm.hexColor(for: .negativeLabel)
