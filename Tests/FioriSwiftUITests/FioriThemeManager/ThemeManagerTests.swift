...
class ThemeManagerTests: XCTestCase {
    override func tearDown() {
        ...
        func testPalette8() throws {
            ...
            XCTAssertEqual(primaryBackground, HexColor(lightColor: "000000FF", darkColor: "FFFFFFFF", elevatedLightColor: "192027FF", contrastLightColor: "000000FF", contrastDarkColor: "FFFFFFFF", elevatedContrastLightColor: "1D252CFF"))
            let secondaryBackground = tm.hexColor(for: .secondaryBackground)
            XCTAssertEqual(secondaryBackground, HexColor(lightColor: "0F1216FF", darkColor: "F5F6F7FF", elevatedLightColor: "1F272FFF", contrastLightColor: "161C21FF", contrastDarkColor: "EAECEEFF", elevatedContrastLightColor: "252E38FF"))
            let tertiaryBackground = tm.hexColor(for: .tertiaryBackground)
            XCTAssertEqual(tertiaryBackground, HexColor(lightColor: "1F2428FF", darkColor: "FFFFFFFF", elevatedLightColor: "242E38FF", contrastLightColor: "1D252CFF", contrastDarkColor: "FFFFFFFF", elevatedContrastLightColor: "2A3540FF"))
            let primaryGroupedBackground = tm.hexColor(for: .primaryGroupedBackground)
            XCTAssertEqual(primaryGroupedBackground, HexColor(lightColor: "000000FF", darkColor: "F5F6F7FF", elevatedLightColor: "192027FF", contrastLightColor: "000000FF", contrastDarkColor: "E8EBEDFF", elevatedContrastLightColor: "1D252CFF"))
            let secondaryGroupedBackground = tm.hexColor(for: .secondaryGroupedBackground)
            XCTAssertEqual(secondaryGroupedBackground, HexColor(lightColor: "1F2428FF", darkColor: "FFFFFFFF", elevatedLightColor: "242E38FF", contrastLightColor: "1D252CFF", contrastDarkColor: "FFFFFFFF", elevatedContrastLightColor: "2A3540FF"))
            let tertiaryGroupedBackground = tm.hexColor(for: .tertiaryGroupedBackground)
            XCTAssertEqual(tertiaryGroupedBackground, HexColor(lightColor: "15181BFF", darkColor: "F5F6F7FF", elevatedLightColor: "1F272FFF", contrastLightColor: "161C21FF", contrastDarkColor: "E8ECEEFF", elevatedContrastLightColor: "252E38FF"))
            ...
            XCTAssertEqual(tertiaryLabel, HexColor(lightColor: "A9B4BEFF", darkColor: "475E75E6", contrastLightColor: "D5DADDFF", contrastDarkColor: "354A5FFF"))
            ...
            XCTAssertEqual(secondaryFill, HexColor(lightColor: "8396A833", darkColor: "5B738B14", contrastLightColor: "8799AB3D", contrastDarkColor: "5B738B33"))
