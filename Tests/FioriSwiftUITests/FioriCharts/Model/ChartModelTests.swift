...
class ChartModelTests: XCTestCase {
    ...
    func testInit() throws {
        ...
        XCTAssertTrue(model.backgroundColor == modelCopy.backgroundColor)
    ...
    func test3DData() throws {
        let model = ChartModel(chartType: .stock,
                               data: [[[16.52, 18.48, 19.21, 20.00, 20000], [22.80, 17.20, 17.48, 22.21, 60000], [18.50, 17.20, 17.48, 22.21, 60000], [24.50, 17.20, 17.48, 22.21, 60000]]],
