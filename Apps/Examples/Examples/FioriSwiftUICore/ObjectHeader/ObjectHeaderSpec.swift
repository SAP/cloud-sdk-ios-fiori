...
struct ObjectHeaderSpec: @preconcurrency ListDataProtocol {
    ...
    func cellForRow(_ indexPath: IndexPath) -> AnyView {
        ...
        case (5, 0):
            let oh = ObjectHeader(title: {
                ...
                Image(systemName: "exclamationmark.square.fill").foregroundColor(.preferredColor(.negativeLabel)).accessibilityLabel("Warning").accessibilityLabel("Warning")
            }, substatus: {
                Text("High Priority")
            }, detailImage: {
                Image("productThumbnail").resizable()
