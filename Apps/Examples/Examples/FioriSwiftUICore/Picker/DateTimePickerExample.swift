        ...
        List {
            ...
            Section(header: Text("")) {
                ...
                DateTimePicker(title: "Numeric Date Style", mandatoryFieldIndicator: self.mandatoryFieldIndicator(), isRequired: self.isRequired, selectedDate: self.$s4, pickerComponents: [.date], dateStyle: .numeric, pickerVisible: self.$pickerVisible3)
                    .aiNoticeView(isPresented: self.$showAINotice, description: "AI Notice")
                DateTimePicker(title: "Auto selected date", mandatoryFieldIndicator: self.mandatoryFieldIndicator(), isRequired: self.isRequired, selectedDate: self.$autoSelectedDate, pickerComponents: [.date], dateStyle: .numeric, pickerVisible: self.$autoSelectedDatePickerVisible, autoSelected: true)
                    .aiNoticeView(isPresented: self.$showAINotice, description: "AI Notice")
