        ...
        List {
            Section(header: Text("Simple Timeline Example")) {
                ...
                Timeline(timestampLabel: "06/25/24", nodeImage: .open(), title: "Project Phase 3", attribute: "feature list: xx, xx, xx", status: .text("pending"))
                    .modifier(CustomListRowModifier())
                Timeline(timestampLabel: "06/28/24", nodeImage: .open(), title: "Project Phase 4", attribute: "feature list: xx, xx, xx", status: .text("pending"))
                    .modifier(CustomListRowModifier())
                TimelineMarker(timestampLabel: "07/05/24", nodeImage: .beforeEnd(), title: "Accept Test")
                    .modifier(CustomListRowModifier())
