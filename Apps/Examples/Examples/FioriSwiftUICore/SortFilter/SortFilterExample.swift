...
struct SortFilterExample: View {
    @State private var items: [[SortFilterItem]] = [
        [
            ...
            .picker(item: .init(name: "List Few No Search", value: [0], valueOptions: ["Received", "Started", "Hold"], allowsMultipleSelection: true, allowsEmptySelection: true, showsValueForSingleSelected: false, isSearchBarHidden: true, icon: "clock", itemLayout: .fixed, displayMode: .list), showsOnFilterFeedbackBar: true),
