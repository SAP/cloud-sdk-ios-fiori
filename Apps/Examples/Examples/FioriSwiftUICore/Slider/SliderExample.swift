    ...
    var body: some View {
        List {
            ...
            FioriSlider(
                ...
                range: 1 ... 80,
                step: 5,
                description: { Text("Simple Custom Slider") },
    ...
    var body: some View {
        List {
            ...
            FioriSlider(
                ...
                step: step,
                decimalPlaces: 5,
                description: { Text("A custom range slider allows you to change the color of the profile image.") },
                valueLabel: {
