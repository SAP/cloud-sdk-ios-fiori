...
struct ObjectItemExample_Previews: PreviewProvider {
    static var previews: some View {
        ObjectItemListView(title: "Single Action P6: Follow Button", listDataType: SingleActionFollowButton.self)
        
        ObjectItemListView(title: "Single Action P6: Follow Button LONG TEXT", listDataType: SingleActionLongFollowButton.self)
        
        ObjectItemListView(title: "Single Action P8-9: Profiles", listDataType: SingleActionProfiles.self)
    }
}
