...
public class ChartModel: ObservableObject, Identifiable, NSCopying, @unchecked Sendable {
                 ...
                 numericAxisLabelFormatHandler: NumericAxisLabelFormatHandler? = nil)
    {
        ...
        if let indexesOfColumnSeries {
            self.indexesOfColumnSeries = IndexSet(indexesOfColumnSeries)
        }
        
        if let indexesOfTotalsCategories {
