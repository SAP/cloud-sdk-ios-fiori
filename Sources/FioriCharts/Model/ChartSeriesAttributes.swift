    ...
    public var description: String {
        ...
        return """
        {
            "ChartSeriesAttributes": {
                "palette": \(String(describing: self.palette)),
                "point": \(String(describing: self.point)),
                "firstLineCapDiameter": \(nf.string(from: NSNumber(value: Double(self.firstLineCapDiameter))) ?? "nil"),
                "lastLineCapDiameter": \(nf.string(from: NSNumber(value: Double(self.lastLineCapDiameter))) ?? "nil")
            }
        }
        """
    }
