...
/// Protocol for a KPIViewSubitem
public protocol KPIViewSubItemModel: Identifiable {
    /// Unique step ID.
    var id: UUID { get }
...
public extension KPIViewSubItem {
    init(model: any KPIViewSubItemModel) {
        self.init(kPIViewSubItemValue: model.kPIViewSubItemValue, kPIViewSubItemType: model.kPIViewSubItemType)
    }
}
