...
public struct PickerItem: Identifiable, Equatable {
    ...
    var label: String {
        self.value.count >= 1 ? "\(self.name) (\(self.value.count))" : "\(self.name)"
    }
...
public struct SliderItem: Identifiable, Equatable {
    ...
    public init(value: Int? = nil, minimumValue: Int, maximumValue: Int, name: String, icon: String? = nil, hint: String? = nil) {
        self.value = value
        self.workingValue = value
        self.originalValue = value
...
public struct DateTimeItem: Equatable, Hashable {
    ...
    public init(value: Date?, name: String, datePickerMode: UIDatePicker.Mode? = nil, dateFormatter: DateFormatter? = nil, icon: String? = nil) {
        self.value = value
        self.workingValue = value
        self.originalValue = value
        self.name = name
...
/*
 Notes:
 a. add hint text to slider, stepper, etc.
 b. support range on slider
 c. to resolve: keyName should not be nillable for menu item, but it can be nil for sheet
 d. fix reset func (bug on original value)
