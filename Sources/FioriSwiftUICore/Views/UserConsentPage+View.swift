    ...
    func makeBody() -> some View {
        ScrollView(.vertical, showsIndicators: true) {
            VStack {
                ...
                if !self.isHtmlContentEmptyView {
                    htmlContent
                        .font(.system(size: 15))
...
struct UserConsentPageLibraryContent: LibraryContentProvider {
    ...
    var views: [LibraryItem] {
        LibraryItem(UserConsentPage(title: "Data Privacy", bodyText: "Detailed text about how data privacy pertains to this app and why it is important for the user to enable this functionality.", htmlContent: nil, footnote: "Learn more about Data Privacy"),
                    category: .control)
    }
}
