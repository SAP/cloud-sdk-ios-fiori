...
extension EnvironmentValues {
    ...
    @MainActor var illustratedMessageTitleStyle: any TitleStyle {
    ...
    @MainActor var illustratedMessageDescriptionStyle: any DescriptionStyle {
    ...
    @MainActor var filterFormViewTitleStyle: any TitleStyle {
    ...
    @MainActor var keyValueFormViewTitleStyle: any TitleStyle {
