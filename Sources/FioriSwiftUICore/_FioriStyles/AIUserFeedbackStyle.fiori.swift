...
public enum AIUserFeedbackVoteState {
    ...
    case notDetermined
    /// Indicates that the user up vote the content generated by AI.
    case upVote
    /// Indicates that the user down vote the content generated by AI.
    case downVote
}
...
public struct AIUserFeedbackBaseStyle: AIUserFeedbackStyle {
    ...
    /// Whether the up vote action has been triggerred more than once, even if change down vote to up vote, submit button should be shown.
    ...
    func contentView(_ configuration: AIUserFeedbackConfiguration) -> some View {
        ...
        .onGeometryChange(for: CGSize.self) { proxy in
            ...
            self.scrollViewHeight = $0.height
        }
