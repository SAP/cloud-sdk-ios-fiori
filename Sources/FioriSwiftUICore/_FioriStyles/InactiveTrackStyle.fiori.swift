...
// Default nss styles
public struct InactiveTrackNSSStyle: InactiveTrackStyle {
    ...
    public func makeBody(_ configuration: InactiveTrackConfiguration) -> some View {
        InactiveTrack(configuration)
            .modifier(NSSStyleModifier<NSSBaseStyleType>(styles: self.data.value(configuration.inactiveTrackIdentifier)))
