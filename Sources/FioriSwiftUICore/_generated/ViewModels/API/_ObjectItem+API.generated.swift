...
extension _ObjectItem where Title == Text,
    ...
    public init(model: _ObjectItemModel) {
    ...
    public init(title: String, subtitle: String? = nil, footnote: String? = nil, descriptionText: String? = nil, status: TextOrIcon? = nil, substatus: TextOrIcon? = nil, detailImage: Image? = nil, icons: [TextOrIcon]? = nil, avatars: [TextOrIcon]? = nil, footnoteIcons: [TextOrIcon]? = nil, tags: [String]? = nil, action: _Action? = nil) {
