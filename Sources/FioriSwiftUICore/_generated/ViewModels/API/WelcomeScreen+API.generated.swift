...
public struct WelcomeScreen<Title: View, DescriptionText: View, Subtitle: View, Footnote: View, Icon: View, TextInputView: View, ActionView: View, SecondaryActionView: View> {
    ...
    var isIconEmptyView: Bool {
        ((self.isModelInit && self.isIconNil) || Icon.self == EmptyView.self) ? true : false
    }

    var isTextInputEmptyView: Bool {
        ((self.isModelInit && self.isTextInputNil) || TextInputView.self == EmptyView.self) ? true : false
    }
...
public extension WelcomeScreen where Title == Text,
    ...
    SecondaryActionView == _ConditionalContent<_Action, EmptyView>
{
    ...
    init(title: String, descriptionText: String? = nil, subtitle: String? = nil, footnote: String? = nil, icon: Image? = nil, textInput: TextInput? = nil, action: _Action? = nil, secondaryAction: _Action? = nil) {
        ...
        self.isIconNil = icon == nil ? true : false
        self.isTextInputNil = textInput == nil ? true : false
