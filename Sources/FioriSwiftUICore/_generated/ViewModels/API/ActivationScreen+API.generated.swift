...
public extension ActivationScreen where Title == Text,
...
{
    init(model: ActivationScreenModel) {
    ...
    init(title: String, descriptionText: String? = nil, footnote: String? = nil, action: _Action? = nil, secondaryAction: _Action? = nil, textInput: TextInput? = nil) {
