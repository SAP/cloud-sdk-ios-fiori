...
public extension ObjectItem where Title == Text,
    ...
    DetailImage == _ConditionalContent<Image, EmptyView>
{
    ...
    init(title: String, subtitle: String? = nil, footnote: String? = nil, descriptionText: String? = nil, status: String? = nil, substatus: String? = nil, detailImage: Image? = nil) {
