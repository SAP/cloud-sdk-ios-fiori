...
public struct UserConsentForm<NextActionView: View, CancelActionView: View, AllowActionView: View, DenyActionView: View, NotNowActionView: View, UserConsentPages: IndexedViewContainer> {
    ...
    var isNextActionEmptyView: Bool {
        ((self.isModelInit && self.isNextActionNil) || NextActionView.self == EmptyView.self) ? true : false
    }
    ...
    var isAllowActionEmptyView: Bool {
        ((self.isModelInit && self.isAllowActionNil) || AllowActionView.self == EmptyView.self) ? true : false
    }

    var isDenyActionEmptyView: Bool {
        ((self.isModelInit && self.isDenyActionNil) || DenyActionView.self == EmptyView.self) ? true : false
    }

    var isNotNowActionEmptyView: Bool {
        ((self.isModelInit && self.isNotNowActionNil) || NotNowActionView.self == EmptyView.self) ? true : false
    }
}

public extension UserConsentForm where NextActionView == _ConditionalContent<_Action, EmptyView>,
...
{
    init(model: UserConsentFormModel) {
    ...
    init(nextAction: _Action? = _Action(model: _NextActionDefault()), cancelAction: _Action? = _Action(model: _CancelActionDefault()), allowAction: _Action? = _Action(model: _AllowActionDefault()), denyAction: _Action? = _Action(model: _DenyActionDefault()), notNowAction: _Action? = _Action(model: _NotNowActionDefault()), userConsentPages: [UserConsentPageModel] = [], isRequired: Bool = true, alertConfiguration: ((UserConsentAlertType) -> AlertConfiguration?)? = _UserConsentFormAlertConfigurationDefault, didAllow: (() -> Void)? = nil, didDeny: ((Bool) -> Void)? = nil, didCancel: (() -> Void)? = nil) {
        ...
        self.isNextActionNil = nextAction == nil ? true : false
        self.isCancelActionNil = cancelAction == nil ? true : false
        self.isAllowActionNil = allowAction == nil ? true : false
        self.isDenyActionNil = denyAction == nil ? true : false
        self.isNotNowActionNil = notNowAction == nil ? true : false
        self.isAlertConfigurationNil = alertConfiguration == nil ? true : false
        self.isDidAllowNil = didAllow == nil ? true : false
        self.isDidDenyNil = didDeny == nil ? true : false
        self.isDidCancelNil = didCancel == nil ? true : false
    }
}
