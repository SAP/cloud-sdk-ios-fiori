...
public extension EULAView where Title == Text,
    ...
    CancelActionView == _ConditionalContent<_Action, EmptyView>
{
    ...
    init(title: String, bodyAttributedText: NSAttributedString? = nil, action: _Action? = _Action(model: _AgreeActionDefault()), secondaryAction: _Action? = _Action(model: _DisagreeActionDefault()), cancelAction: _Action? = _Action(model: _CancelActionDefault()), didAgree: (() -> Void)? = nil, didDisagree: (() -> Void)? = nil, didCancel: (() -> Void)? = nil) {
        ...
        self.isDidAgreeNil = didAgree == nil ? true : false
        self.isDidDisagreeNil = didDisagree == nil ? true : false
