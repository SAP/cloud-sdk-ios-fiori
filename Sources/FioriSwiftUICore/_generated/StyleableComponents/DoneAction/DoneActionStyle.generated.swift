...
@MainActor @preconcurrency public protocol DoneActionStyle: DynamicProperty {
    associatedtype Body: View

    @MainActor @ViewBuilder @preconcurrency func makeBody(_ configuration: DoneActionConfiguration) -> Body
}
