...
@MainActor @preconcurrency public protocol NextActionStyle: DynamicProperty {
    associatedtype Body: View

    @MainActor @ViewBuilder @preconcurrency func makeBody(_ configuration: NextActionConfiguration) -> Body
}
