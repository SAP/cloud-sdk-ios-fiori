...
public struct TextFieldFormView {
    ...
    public init(@ViewBuilder title: () -> any View,
                ...
                @ViewBuilder mandatoryIndicator: () -> any View = { EmptyView() },
                ...
                action: (() -> Void)? = nil)
    {
        ...
        self.mandatoryIndicator = MandatoryIndicator { mandatoryIndicator() }
...
extension TextFieldFormView: View {
    public var body: some View {
        if self._shouldApplyDefaultStyle {
            ...
            self.style.resolve(configuration: .init(title: .init(self.title), text: self.$text, placeholder: .init(self.placeholder), controlState: self.controlState, errorMessage: self.errorMessage, maxTextLength: self.maxTextLength, hintText: self.hintText, hidesReadOnlyHint: self.hidesReadOnlyHint, isCharCountEnabled: self.isCharCountEnabled, allowsBeyondLimit: self.allowsBeyondLimit, charCountReachLimitMessage: self.charCountReachLimitMessage, charCountBeyondLimitMsg: self.charCountBeyondLimitMsg, mandatoryIndicator: .init(self.mandatoryIndicator), isRequired: self.isRequired, actionIcon: self.actionIcon, action: self.action)).typeErased
...
private extension TextFieldFormView {
    ...
    func defaultStyle() -> some View {
        TextFieldFormView(.init(title: .init(self.title), text: self.$text, placeholder: .init(self.placeholder), controlState: self.controlState, errorMessage: self.errorMessage, maxTextLength: self.maxTextLength, hintText: self.hintText, hidesReadOnlyHint: self.hidesReadOnlyHint, isCharCountEnabled: self.isCharCountEnabled, allowsBeyondLimit: self.allowsBeyondLimit, charCountReachLimitMessage: self.charCountReachLimitMessage, charCountBeyondLimitMsg: self.charCountBeyondLimitMsg, mandatoryIndicator: .init(self.mandatoryIndicator), isRequired: self.isRequired, actionIcon: self.actionIcon, action: self.action))
