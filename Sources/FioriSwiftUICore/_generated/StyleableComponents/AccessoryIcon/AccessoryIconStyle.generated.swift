...
@MainActor @preconcurrency public protocol AccessoryIconStyle: DynamicProperty {
    associatedtype Body: View

    @MainActor @ViewBuilder @preconcurrency func makeBody(_ configuration: AccessoryIconConfiguration) -> Body
}
