...
@MainActor @preconcurrency public protocol BodyTextStyle: DynamicProperty {
    associatedtype Body: View

    @MainActor @ViewBuilder @preconcurrency func makeBody(_ configuration: BodyTextConfiguration) -> Body
}
