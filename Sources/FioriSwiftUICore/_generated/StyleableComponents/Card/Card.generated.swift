...
public struct Card {
    ...
    public init(@ViewBuilder mediaImage: () -> any View = { EmptyView() },
                ...
                @ViewBuilder mediaLeftImage: () -> any View = { EmptyView() },
