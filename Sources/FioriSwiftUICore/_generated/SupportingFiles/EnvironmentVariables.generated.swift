...
extension EnvironmentValues {
    var activityItemStyle: any ActivityItemStyle {
        self.activityItemStyleStack.last ?? .base.concat(.fiori).concat(.globalNSS)
    }
...
extension EnvironmentValues {
    var contactItemStyle: any ContactItemStyle {
        self.contactItemStyleStack.last ?? .base.concat(.fiori).concat(.globalNSS)
    }
...
extension EnvironmentValues {
    var fioriSliderStyle: any FioriSliderStyle {
        self.fioriSliderStyleStack.last ?? .base.concat(.fiori).concat(.globalNSS)
    }
...
extension EnvironmentValues {
    var headerChartStyle: any HeaderChartStyle {
        self.headerChartStyleStack.last ?? .base.concat(.fiori).concat(.globalNSS)
    }
...
extension EnvironmentValues {
    var kPIProgressItemStyle: any KPIProgressItemStyle {
        self.kPIProgressItemStyleStack.last ?? .base.concat(.fiori).concat(.globalNSS)
    }
...
extension EnvironmentValues {
    var objectHeaderStyle: any ObjectHeaderStyle {
        self.objectHeaderStyleStack.last ?? .base.concat(.fiori).concat(.globalNSS)
    }
...
extension EnvironmentValues {
    var rangeSliderControlStyle: any RangeSliderControlStyle {
        self.rangeSliderControlStyleStack.last ?? .base.concat(.fiori).concat(.globalNSS)
    }
...
extension EnvironmentValues {
    var sectionFooterStyle: any SectionFooterStyle {
        self.sectionFooterStyleStack.last ?? .base.concat(.fiori).concat(.globalNSS)
    }
...
extension EnvironmentValues {
    var sectionHeaderStyle: any SectionHeaderStyle {
        self.sectionHeaderStyleStack.last ?? .base.concat(.fiori).concat(.globalNSS)
    }
...
extension EnvironmentValues {
    var singleStepStyle: any SingleStepStyle {
        self.singleStepStyleStack.last ?? .base.concat(.fiori).concat(.globalNSS)
    }
...
extension EnvironmentValues {
    var stepProgressIndicatorStyle: any StepProgressIndicatorStyle {
        self.stepProgressIndicatorStyleStack.last ?? .base.concat(.fiori).concat(.globalNSS)
    }
