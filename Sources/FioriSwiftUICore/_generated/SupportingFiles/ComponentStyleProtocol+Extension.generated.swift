...
public struct KeyValueItemMandatoryFieldIndicatorStyle: KeyValueItemStyle {
    let style: any MandatoryFieldIndicatorStyle
...
public extension KeyValueItemStyle where Self == KeyValueItemMandatoryFieldIndicatorStyle {
    static func mandatoryFieldIndicatorStyle(_ style: some MandatoryFieldIndicatorStyle) -> KeyValueItemMandatoryFieldIndicatorStyle {
        KeyValueItemMandatoryFieldIndicatorStyle(style: style)
    }

    static func mandatoryFieldIndicatorStyle(@ViewBuilder content: @escaping (MandatoryFieldIndicatorConfiguration) -> some View) -> KeyValueItemMandatoryFieldIndicatorStyle {
        let style = AnyMandatoryFieldIndicatorStyle(content)
        return KeyValueItemMandatoryFieldIndicatorStyle(style: style)
    }
}
