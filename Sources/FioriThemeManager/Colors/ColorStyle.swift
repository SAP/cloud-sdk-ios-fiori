...
public enum ColorStyle: String, CaseIterable, Sendable {
    ...
    /// Chart 1
    /// (dark variant) ![](https://dummyimage.com/48x18/3278BE.png&text=+)          Hex value: 168EFFFF
    /// (light variant) ![](https://dummyimage.com/48x18/168EFF.png&text=+)          Hex value: 3278BEFF
    @available(watchOS, unavailable)
    case chart1
    ...
    #if !os(watchOS)
        public nonisolated(unsafe) static var allCases: [ColorStyle] = [.grey1, .grey2, .grey3, .grey4, .grey5, .grey6,
